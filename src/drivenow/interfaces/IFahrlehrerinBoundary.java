...
public interface IFahrlehrerinBoundary {
	 ...
	 * alle für sie eingetragenen Unterrichtsstunden ab. Passt der Name der
	 ...
	 * Unterrichtsstunden für die Fahrlehrerin wird der Text
	 ...
	 * wird im Feld Text des Systemerieignisses transportiert und NICHT direkt
	 * ausgegeben.
	 * 
	 * PRE: true.
	 * 
