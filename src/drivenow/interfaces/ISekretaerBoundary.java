...
public interface ISekretaerBoundary {
	 ...
	 * Fahrlehrerin wird vernachlässigt. Fahrpruefungen werden nicht ueber diese
	 * Methode eingetragen.
	 * 
	 ...
	 * müssen Prüfungsfahrten bei der Verfuegbarkeitspruefung der Fahrlehrerin
	 ...
	 * mehrere Fahrstunden hintereinander für den Fahrschueler eingetragen sind,
	 ...
	 * im Feld Text des Systemerieignisses transportiert und NICHT direkt
	 * ausgegeben. Sind keine Daten im System wird der Text
	 * "Keine Daten im System" uebermittelt.
	 * 
	 * PRE: true.
	 * 
	 ...
	 * Fahrprüfung dauert 180 Minuten.
	 * 
